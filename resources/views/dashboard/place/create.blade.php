                ...
                <form action="{{ route('places.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation mb-4" accept-charset="utf-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" name="points_per_visit" class="form-control" id="pointsPerVisitInput" value="{{ old('points_per_visit') }}" placeholder="Введите баллов за посещение" maxlength="100" required autofocus>
                        </div>
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input readonly type="text" name="lat" class="form-control" id="latInput" value="{{ old('lat') }}" placeholder="*.*************" maxlength="100" required autofocus>
                        </div>

                        <div class="col-6 mb-3">
                            <label for="lngInput" class="form-label">Долгота</label>
                            <input readonly type="text" name="lng" class="form-control" id="lngInput" value="{{ old('lng') }}" placeholder="*.*************" maxlength="100" required autofocus>
                        </div>
                    </div>
