<x-dashboard-layout title="Редактирование сотрудника #{{ $user->id }}">
    <x-dashboard-header-small pretitle="Данные" title="Сотрудник #{{ $user->id }}">
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
                <form action="{{ route('employees.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation mb-4" accept-charset="utf-8">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-6 mb-3">
                            <label for="fullNameInput" class="form-label">ФИО</label>
                            <input type="text" name="full_name" class="form-control" id="fullNameInput" value="{{ old('full_name', $user->full_name) }}" placeholder="Введите ФИО" maxlength="100" required autofocus>
                        </div>
                        <div class="col-6  mb-3">
